...
Created 2014 by Kenneth Love
Updated 2020 by Allison Cuyjet
"""
...
def get_locations(cells):
    """Randomly pick starting locations for the monsters, the door, and the player
...
def move_player(player, move):
    """Based on the tuple of the player's current position, move to new location

    >>> move_player({'location': (1, 1), 'path': []}, 'RIGHT')
    (2, 1)
